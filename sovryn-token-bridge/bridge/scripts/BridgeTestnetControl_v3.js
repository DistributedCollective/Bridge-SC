...
const AbisObject = require("./BridgeTestnetAddresses").abisObject;
const BscBSCConfig = require("./BridgeTestnetAddresses").bscBSCConfig;
const RskBSCConfig = require("./BridgeTestnetAddresses").rskBSCConfig;
const EthETHConfig = require("./BridgeTestnetAddresses").ethETHConfig;
const RskETHConfig = require("./BridgeTestnetAddresses").rskETHConfig;
const BtestnetStableCoins = require("./BridgeTestnetAddresses").btestnetStableCoins;
const TestnetStableCoins = require("./BridgeTestnetAddresses").testnetStableCoins;
const RskbsctestnetStableCoins = require("./BridgeTestnetAddresses").rskbsctestnetStableCoins;
const RskethtestnetStableCoins = require("./BridgeTestnetAddresses").rskethtestnetStableCoins;
const RsktestnetTokens = require("./BridgeTestnetAddresses").rsktestnetTokens;
const BtestnetETHToken = require("./BridgeTestnetAddresses").btestnetETHToken;
const RskbsctestnetETHToken = require("./BridgeTestnetAddresses").rskbsctestnetETHToken;
const BtestnetBNB = require("./BridgeTestnetAddresses").btestnetBNB;
const RskbsctestnetBNB = require("./BridgeTestnetAddresses").rskbsctestnetBNB;
const TestnetSOV = require("./BridgeTestnetAddresses").testnetSOV;
const BtestnetSOV = require("./BridgeTestnetAddresses").btestnetSOV;
