const fs = require('fs');
const AbisObject = require("./BridgeTestnetAddresses_v5").abisObject;
const BscBSCConfig = require("./BridgeTestnetAddresses_v5").bscBSCConfig;
const RskBSCConfig = require("./BridgeTestnetAddresses_v5").rskBSCConfig;
const EthETHConfig = require("./BridgeTestnetAddresses_v5").ethETHConfig;
const RskETHConfig = require("./BridgeTestnetAddresses_v5").rskETHConfig;
const BtestnetStableCoins = require("./BridgeTestnetAddresses_v5").btestnetStableCoins;
const TestnetStableCoins = require("./BridgeTestnetAddresses_v5").testnetStableCoins;
const RskbsctestnetStableCoins = require("./BridgeTestnetAddresses_v5").rskbsctestnetStableCoins;
const RskethtestnetStableCoins = require("./BridgeTestnetAddresses_v5").rskethtestnetStableCoins;
const RsktestnetTokens = require("./BridgeTestnetAddresses_v5").rsktestnetTokens;
const BtestnetETHToken = require("./BridgeTestnetAddresses_v5").btestnetETHToken;
const RskbsctestnetETHToken = require("./BridgeTestnetAddresses_v5").rskbsctestnetETHToken;
const BtestnetBNB = require("./BridgeTestnetAddresses_v5").btestnetBNB;
const RsktestnetRBTC = require("./BridgeTestnetAddresses_v5").rsktestnetRBTC;
const RskbsctestnetBNB = require("./BridgeTestnetAddresses_v5").rskbsctestnetBNB;
const BscbscbtestnetRBTC = require("./BridgeTestnetAddresses_v5").bscbscbtestnetRBTC;
const TestnetSOV = require("./BridgeTestnetAddresses_v5").testnetSOV;
const BtestnetSOV = require("./BridgeTestnetAddresses_v5").btestnetSOV;
