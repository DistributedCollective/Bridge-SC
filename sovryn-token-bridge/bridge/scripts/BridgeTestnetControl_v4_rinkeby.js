const fs = require('fs');
const AbisObject = require("./BridgeTestnetAddresses_v4_rinkeby").abisObject;
const BscBSCConfig = require("./BridgeTestnetAddresses_v4_rinkeby").bscBSCConfig;
const RskBSCConfig = require("./BridgeTestnetAddresses_v4_rinkeby").rskBSCConfig;
const EthETHConfig = require("./BridgeTestnetAddresses_v4_rinkeby").ethETHConfig;
const RskETHConfig = require("./BridgeTestnetAddresses_v4_rinkeby").rskETHConfig;
const BtestnetStableCoins = require("./BridgeTestnetAddresses_v4_rinkeby").btestnetStableCoins;
const TestnetStableCoins = require("./BridgeTestnetAddresses_v4_rinkeby").testnetStableCoins;
const RskbsctestnetStableCoins = require("./BridgeTestnetAddresses_v4_rinkeby").rskbsctestnetStableCoins;
const RskethtestnetStableCoins = require("./BridgeTestnetAddresses_v4_rinkeby").rskethtestnetStableCoins;
const RsktestnetTokens = require("./BridgeTestnetAddresses_v4_rinkeby").rsktestnetTokens;
const BtestnetETHToken = require("./BridgeTestnetAddresses_v4_rinkeby").btestnetETHToken;
const RskbsctestnetETHToken = require("./BridgeTestnetAddresses_v4_rinkeby").rskbsctestnetETHToken;
const BtestnetBNB = require("./BridgeTestnetAddresses_v4_rinkeby").btestnetBNB;
const RsktestnetRBTC = require("./BridgeTestnetAddresses_v4_rinkeby").rsktestnetRBTC;
const RskbsctestnetBNB = require("./BridgeTestnetAddresses_v4_rinkeby").rskbsctestnetBNB;
const TestnetSOV = require("./BridgeTestnetAddresses_v4_rinkeby").testnetSOV;
const BtestnetSOV = require("./BridgeTestnetAddresses_v4_rinkeby").btestnetSOV;
...
module.exports = async callback => {
    try {
        ...
        if( bridgeType == "h" || bridgeType == "help" ) {
            ...
            'net: testnet, btestnet, rsktestnet, ropsten, btestnet, rsktestnet, rinkeby\n' +
            'bridgeType: bsc, eth\n'+
            ...
            'Federation: removeMember addMember setRevokeTransactionAndVote endDeploymentSetup\n\n' +
            'Example: \n' + 
        ...
        if(netType == "btestnet") {
            ...
            if(tokenType == "stable") {
                tokens = [
                    TestnetStableCoins.DAI_Testnet[4].address,
                    TestnetStableCoins.USDT_Testnet[4].address,
                    TestnetStableCoins.USDC_Testnet[4].address,
                ];
                decimals = [
                    TestnetStableCoins.DAI_Testnet[4].decimals,
                    TestnetStableCoins.USDT_Testnet[4].decimals,
                    TestnetStableCoins.USDC_Testnet[4].decimals,
                ];
            }
            else if(tokenType == "sov") {
                tokens = [
                    TestnetSOV.SOV_Testnet[4].address
                ];
                decimals = [
                    TestnetSOV.SOV_Testnet[4].decimals
                ];
            };
            bridgeAddress = EthETHConfig.bridge;
            federationAddress = EthETHConfig.federation;
        ...
        // Federation control
            ...
            else if(enableMethod == "endDeploymentSetup") {
                smartContract = "federation";
                functionData = federation.methods
                .endDeploymentSetup()
                .encodeABI();
        ...
        if(smartContract == "bridge") {
            ...
            .send({ from: deployer ,gas: 3000000, gasPrice: gasPriceNow });
        }
