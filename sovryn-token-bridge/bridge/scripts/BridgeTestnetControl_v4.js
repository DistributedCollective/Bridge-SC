const fs = require('fs');
const AbisObject = require("./BridgeTestnetAddresses_v4").abisObject;
const BscBSCConfig = require("./BridgeTestnetAddresses_v4").bscBSCConfig;
const RskBSCConfig = require("./BridgeTestnetAddresses_v4").rskBSCConfig;
const EthETHConfig = require("./BridgeTestnetAddresses_v4").ethETHConfig;
const RskETHConfig = require("./BridgeTestnetAddresses_v4").rskETHConfig;
const BtestnetStableCoins = require("./BridgeTestnetAddresses_v4").btestnetStableCoins;
const TestnetStableCoins = require("./BridgeTestnetAddresses_v4").testnetStableCoins;
const RskbsctestnetStableCoins = require("./BridgeTestnetAddresses_v4").rskbsctestnetStableCoins;
const RskethtestnetStableCoins = require("./BridgeTestnetAddresses_v4").rskethtestnetStableCoins;
const RsktestnetTokens = require("./BridgeTestnetAddresses_v4").rsktestnetTokens;
