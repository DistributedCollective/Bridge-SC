...
module.exports = async callback => {
    try {
        ...
        const AllowTokens_deployed = await AllowTokens.deployed();
        const AllowTokens_deployed_Address = AllowTokens_deployed.address;
        console.log("AllowTokens deployed " +  AllowTokens_deployed_Address);
        ...
        console.log("multisig address allow token" +  multiSigAddress);

        const multisig_deployed = await MultiSigWallet.deployed();
        const multisig_deployed_Address = multisig_deployed.address;
        console.log("multisig deployed " +  multisig_deployed_Address);
